...
$string['channelnew'] = 'New series';
$string['channelchoose'] = 'Choose an existing series';
$string['channelexisting'] = 'Existing series';
...
$string['modulename_help'] =
        'The SWITCHcast module allows a teacher to manage a SWITCHcast video series from a Moodle course.';
...
$string['access_desc'] = 'Access level for created series.';
...
$string['enabled_templates_desc'] =
        'List here each SwitchCast template you wish to enable for your institution (enforced for series\'s creation only).<br />One definition per line, format : <em>&lt;TEMPLATE_ID&gt;::&lt;TEMPLATE_NAME&gt;</em>.<br />You may omit the template name (but not the two colons) to use Switch\'s official name for a template.';
$string['newchannelname'] = 'New series name';
...
$string['edit_at_switch'] = 'Edit this series on the SWITCHcast server';
$string['edit_at_switch_short'] = 'Edit at SWITCHcast';
$string['opencast:use'] = 'Display SWITCHcast series contents';
$string['opencast:isproducer'] = 'Be registered as a SWITCHcast series producer (and hence access all clips)';
$string['opencast:addinstance'] = 'Add a new SWITCHcast series activity';
...
$string['noclipsinchannel'] = 'This series contains no clips.';
$string['novisibleclipsinchannel'] = 'This series contains no clips that you have access to.';
$string['user_notaai'] = 'You need a SWITCHaai account to create a new series.';
...
$string['back_to_channel'] = 'Return to the series overview';
$string['channel_several_refs'] = 'This series is referenced in other Moodle activities.';
...
$string['channelhasotherextauth'] = 'This series is already linked to another external authority: <em>{$a}</em>.';
...
$string['channel_not_found'] = 'The linked series does not exist (anymore?)';
$string['channeldoesnotbelong'] =
        'The linked series belongs to another organization ({$a}); therefore, you cannot modify it. Only a teacher from {$a} can modify it.';
...
$string['badorganization'] = 'This series\'s organization is not configured correctly.';
...
$string['allow_userupload_desc'] =
        'Allow users to upload video clips into a series via the Moodle activity. The corresponding option has to be activated in the specific activity as well.';
...
$string['pendingclips'] = 'There are {$a} clips being processed in this series';
$string['mypendingclips'] = 'You have {$a} clips being processed in this series';
$string['uploadedclips'] = '{$a} clips have been uploaded to this series';
$string['myuploadedclips'] = 'You have uploaded {$a} clips into this series';
...
$string['curl_timeout_desc'] =
        'How long to wait for an answer from the SWITCHcast API server for, in seconds. Increase this value if you have series with lots of clips and the SWITCHcast server fails to respond timely.';
