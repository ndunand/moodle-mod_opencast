...
/**
 * opencast restore task that provides all the settings and steps to perform one
...
class restore_opencast_activity_task extends restore_activity_task {
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('opencast', 'report', 'report.php?id={course_module}', '{opencast}');
    ...
    static public function define_restore_log_rules_for_course() {
        ...
        $rules[] = new restore_log_rule('opencast', 'view all', 'index?id={course}', null, null, null,
                'index.php?id={course}');
